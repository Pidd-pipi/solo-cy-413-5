...
export interface PlanSource{window_days:number;mood_count:number;raw_mood_count:number;journal_count:number;assessment_count:number;avg_mood:number;dominant_tag:string;latest_result:string;summary:string[];input_hash:string}
